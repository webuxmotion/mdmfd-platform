<?php
  ...
  Router::add('^(?P<username>[A-Za-z_.-]+)/?(?P<segment>[A-Za-z0-9_.-]+)/?$', ['controller' => 'Desk', 'action' => 'showDesk']);
  Router::add('^(?P<username>[A-Za-z_.-]+)/?(?P<segment>[A-Za-z0-9_.-]+)/?(?P<cardSegment>[A-Za-z0-9_.-]+)/?$', ['controller' => 'Desk', 'action' => 'showCard']);
